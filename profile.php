   ...
   <div id="sidebar-wrapper" data-simplebar="" data-simplebar-auto-hide="true">
     <div class="brand-logo">
      <a href="index.html">
       ...
       <h5 class="logo-text">Abhishek Yevle</h5>
     </a>
   </div>
       ...
       <li class="dropdown-item user-details">
        <a href="javaScript:void();">
           <div class="media">
            ...
            <h6 class="mt-2 user-title">Abhishek Yevle</h6>
            <p class="user-subtitle">abhishek.yevle@yahoo.com</p>
            </div>
           </div>
          </a>
        </li>
        ...
        <div class="col-lg-4">
           <div class="card profile-card-2">
            ...
            <div class="card-body pt-5">
                ...
                <h5 class="card-title">Abhishek Yevle</h5>
                <p class="card-text">I am a PHP web developer. I have proficiency in front-end development and back-end web development,
coding with HTML, CSS, and JS for the client-side, and maintaining databases and infrastructure server-side
with PHP & MY SQL.</p>
                 ...
                 <div class="media align-items-center">
                   <div>
                     ...
                     <div class="media-body text-left ml-3">
                       <div class="progress-wrapper">
                         <p>HTML5 <span class="float-right">80%</span></p>
                  ...
                  <div class="media align-items-center">
                   <div><img src="assets/images/timeline/bootstrap-4.svg" class="skill-img" alt="skill img"></div>
                     <div class="media-body text-left ml-3">
                       <div class="progress-wrapper">
                         <p>Bootstrap 5 <span class="float-right">70%</span></p>
                         <div class="progress" style="height: 5px;">
                  ...
                  <div class="media align-items-center">
                   <div><img src="assets/images/timeline/angular-icon.svg" class="skill-img" alt="skill img"></div>
                     <div class="media-body text-left ml-3">
                       <div class="progress-wrapper">
                         <p>CSS3 <span class="float-right">60%</span></p>
                         <div class="progress" style="height: 5px;">
                  ...
                  <div class="media align-items-center">
                   <div><img src="assets/images/timeline/react.svg" class="skill-img" alt="skill img"></div>
                     <div class="media-body text-left ml-3">
                       <div class="progress-wrapper">
                         <p>PHP7<span class="float-right">35%</span></p>
                         <div class="progress" style="height: 5px;">
                ...
                <div class="tab-pane active" id="profile">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <h6>Hobbies</h6>
                            <p>
								Adventuring | Cycling | Fitness | Web Surfing
							</p>
                        </div>
                        <div class="col-md-6">
                            <h6>Recent badges</h6>
                            ...
                            <a href="javascript:void();" class="badge badge-dark badge-pill">bootstrap5</a>
                            <a href="javascript:void();" class="badge badge-dark badge-pill">php7</a>
                            <a href="javascript:void();" class="badge badge-dark badge-pill">responsive-design</a>
                            <hr>
                            <span class="badge badge-primary"><i class="fa fa-user"></i> 00 Followers</span>
                            <span class="badge badge-success"><i class="fa fa-cog"></i> 01 Forks</span>
                            <span class="badge badge-danger"><i class="fa fa-eye"></i> 00 Views</span>
                        </div>
                        <div class="col-md-12">
