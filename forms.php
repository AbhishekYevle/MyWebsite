      ...
      <div class="col-lg-12">
         <div class="card">
			...
			<?php
				...
				if(isset($_POST['submit_btn']))
				{
				   ...
				   else
				   {
					   ...
					   $sql="insert into tbluser(id,username,firstname,lastname,emailid,mobileno,password) values(NULL,'$uname','$fname','$lname','$email','$mobileno','$pass')";
					   if(mysqli_query($con,$sql))
					   {
						   echo "New Admin is Created Successfuly.";
					   }
					   else
					   {
						   echo "ERROR";
           ...
           <div class="form-group">
            ...
            <input type="email" class="form-control" id="emailid" name="emailid" placeholder="Enter Your Email Address">
           </div>
           <div class="form-group">
           ...
           <div class="form-group">
            <button type="submit" id="submit_btn" name="submit_btn" class="btn btn-light px-5"><i class="icon-lock"></i> Register</button>
          </div>
          </form>
         </div>
         </div>
