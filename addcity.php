  ...
  <div class="content-wrapper">
    ...
    <div class="row mt-3">
      <div class="col-lg-12">
         <div class="card">
           <div class="card-body">
           <div class="card-title">City Form</div>
           <hr>
			...
			<?php
				...
				if(isset($_POST['submit_btn']))
				{
					...
					if(empty($sid))
				   {
					 echo "<p style=\"color:red\">Please Enter Your State_ID!</p>";
				   }
				   else if(empty($city))
				   {
					   echo "<p style=\"color:red\">Please Enter Your City Name!</p>";
				   }
				   else
				   {
					   $con=mysqli_connect(@"localhost","root","","demo1");
					   $sql="insert into tblcity(id,stateid,cityname) values(NULL,'$sid','$city')";
					   if(mysqli_query($con,$sql))
					   {
						   echo "New City is Added Successfully.";
					   }
					   else
					   {
						   echo "ERROR";
           ...
           <div class="form-group">
            <label for="stateid">State_ID</label>
            <input type="text" class="form-control" id="stateid" name="stateid" placeholder="Enter Your State ID">
           </div>
		   <div class="form-group">
            <label for="cityname">City Name</label>
            <input type="text" class="form-control" id="cityname" name="cityname" placeholder="Enter Your City Name">
           </div>
           ...
           <div class="form-group">
            <button type="submit" id="submit_btn" name="submit_btn" class="btn btn-light px-5"><i class="icon-lock"></i> ADD</button>
          </div>
          </form>
         </div>
         </div>
