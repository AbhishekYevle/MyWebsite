      ...
      <li class="nav-item">
            ...
            <div class="collapse" id="form-elements">
              <ul class="nav flex-column sub-menu">
                ...
                <li class="nav-item"><a class="nav-link" href="">View City</a></li>
                <li class="nav-item"><a class="nav-link" href="">View State</a></li>
              </ul>
            </div>
          </li>
							...
							else
							{
								...
								{	$id=$line['id'];
									...
									echo "<table class=\"table table-striped\">
											...
											<tr><th>UserName : </th><td>$u</td></tr>
											<tr><th>FirstName : </th><td>$f</td></tr>
											<tr><th>LastName : </th><td>$l</td></tr>
											<tr><th>Mobileno :</th><td>$m</td></tr>
											<tr><th>Emailid : </th><td>$e</td></tr>
										  </table>
										  ";
								}
							}
